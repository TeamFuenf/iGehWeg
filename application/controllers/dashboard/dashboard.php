...
class Dashboard extends CI_Controller
{
  ...
  public function index()
  {
   ...
   // $data["knearestfriends"] = $this->Friends_model->getKNearestFriends(5);
    ...
    $data["eventlink"] = anchor("/event", "<img src='../../images/newevent_blue.png' /><div id='button_header'>Events<br><span class='additional_text'>Hier kannst du neue Events erstellen</span></div>", array( 'class' => 'list_entry'));
